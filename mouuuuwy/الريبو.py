...
async def restart(client, m: Message):
    ...
    quit()
@Client.on_message(filters.command(["2مصطفى"], prefixes=f"{HNDLR}"))
...
<b>👋 اهلا {m.from_user.mention}!
 ...
 𝘮𝘶𝘴𝘪𝘤 
اهلا بك في سورس دايفل  هي كما ياتي:
1 شغل - اسم الاغنيه |لتشغيل الاغاني
2  انهاء لايقاف الاغاني
...
سورس مال واحد زباله هذا المطور ماله : @V66VU
"""
